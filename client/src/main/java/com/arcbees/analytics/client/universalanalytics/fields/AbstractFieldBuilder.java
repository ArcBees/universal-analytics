...
import com.arcbees.analytics.client.universalanalytics.HitCallback;
import com.arcbees.analytics.client.universalanalytics.OptionsCallback;
...
public abstract class AbstractFieldBuilder {
    ...
    private native void addHitCallback(JSONObject jsonObject, HitCallback callback) /*-{
        jsonObject.hitCallback = function() {
            callback.@com.arcbees.analytics.client.universalanalytics.HitCallback::callback()();
        }
    }-*/;
